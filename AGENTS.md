...
- Reuse an existing component from `components/magicui` or the Magic UI/shadcn registry before writing a new component.
...
- Keep every reusable UI component under `components/magicui`; this project does not maintain a separate `components/ui` library.
