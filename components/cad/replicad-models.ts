export type CadModelId = 'spur-gear' | 'phone-stand' | 'workbench-table' | 'desktop-robot';
...
export function labelForModel(model: CadModelId) {
  return { 'spur-gear': 'Spur gear', 'phone-stand': 'Phone stand', 'workbench-table': 'Workbench table', 'desktop-robot': 'Desktop robot' }[model];
}
