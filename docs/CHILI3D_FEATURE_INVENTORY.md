...
- [x] Save Chili3D exports as derived revisions through the project-scoped chili-import endpoint with parentRevisionId. Historical live STEP tests produced revisions 2 and 3; the current route wiring was corrected in the September 25 integration pass.
