...
import { meshHelpers, measureRawMesh, validateRawMesh } from './mesh-helpers.mjs';
...
export function runCode(code, replicad, { timeoutMs = 60_000 } = {}) {
  ...
  const sandbox = Object.freeze({ ...replicad, ...meshHelpers, replicad, helpers: meshHelpers, console: Object.freeze({ log() {}, warn() {} }) });
