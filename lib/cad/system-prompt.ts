import { REPLICAD_API_REFERENCE } from './replicad-api-reference';
...
- Every replicad export (makeBaseBox, draw, loft helpers, ...) and every helper (meshFromGrid, latheMesh, ...) is already in scope by name; you may also destructure them from replicad / helpers.
