    ...
    guide: [
        {
            ...
            content:
                "The Agentic CAD tab has a 'Send to Replicad' button that exports the current model as STEP back to the Agentic CAD workspace this editor was opened from.",
        },
    ],
    i18nResources: [
        {
            ...
            translation: {
                ...
                "command.agenticCad.sendToReplicad": "Send to Replicad",
                "agenticCad.sendToReplicad.help": "Export this model back to the Agentic CAD workspace",
                "agenticCad.sent": "Model sent back to Agentic CAD",
                "agenticCad.notEmbedded": "Open this editor from the Agentic CAD workspace to send models back",
                "agenticCad.received": "Model imported from Agentic CAD",
                "agenticCad.noDocument": "Nothing to send yet",
                "agenticCad.noModel": "Add a model before sending it back",
        ...
        },
        {
            ...
            translation: {
                ...
                "command.agenticCad.sendToReplicad": "发送到 Replicad",
                "agenticCad.sendToReplicad.help": "将当前模型导出回 Agentic CAD 工作区",
                "agenticCad.sent": "模型已发送回 Agentic CAD",
                "agenticCad.notEmbedded": "请从 Agentic CAD 工作区打开此编辑器以发送模型",
                "agenticCad.received": "已从 Agentic CAD 导入模型",
                "agenticCad.noDocument": "暂无可发送的内容",
